...
<body>
	...
	<div class="container">
		...
		<form id="regform" action="saveImage" method="post"
			...
			<div class="col-md-6 m-auto">
				...
				<div class="form-group">
					<label id="label" class="form-label m-0 p-1 pull-left" for="food"><h3>Select
							Food:</h3></label> <select name="foodId">
						<c:forEach items="${foods}" var="u">
							<option class="option" value="${u.foodId}">${u.foodName}</option>
						</c:forEach>
					</select>
				</div>
				<div class="form-group">
